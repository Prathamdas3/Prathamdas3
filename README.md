...
<img src="https://skillicons.dev/icons?i=py,js,ts,md,html,css,bootstrap,tailwind,react,next,vue,nuxt,astro,redux,vite,firebase,bun,nodejs,npm,pnpm,express,prisma,mongodb,sqlite,netlify,vercel,github,git,bash,postman,docker,vscode,linux,redhat,figma,notion" align="center"/>
